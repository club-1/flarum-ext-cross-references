...
flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().initializers.add('club-1-cross-references', function (app) {
  app.extensionData["for"]('club-1-cross-references').registerSetting({
