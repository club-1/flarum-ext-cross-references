...
var DiscussionReferencedPost = /*#__PURE__*/function (_EventPost) {
  ...
  _proto.descriptionData = function descriptionData() {
    return {
      source: m((flarum_common_components_Link__WEBPACK_IMPORTED_MODULE_3___default()), {
        href: flarum_forum_app__WEBPACK_IMPORTED_MODULE_1___default().route('discussion', {
          id: this.attrs.source.id()
        })
      }, this.attrs.source.title())
    };
  };
...
/* harmony import */ var _components_DiscussionReferencedPost__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/DiscussionReferencedPost */ "./src/forum/components/DiscussionReferencedPost.js");
/*
 * This file is part of club-1/flarum-ext-cross-references.
 *
 * Copyright (c) 2022 Nicolas Peugnet <nicolas@club1.fr>.
...
flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().initializers.add('club-1/flarum-ext-cross-references', function () {
  (flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().postComponents.discussionReferenced) = _components_DiscussionReferencedPost__WEBPACK_IMPORTED_MODULE_1__["default"];
});
