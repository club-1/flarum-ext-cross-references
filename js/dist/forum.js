...
/* harmony import */ var flarum_tags_helpers_tagsLabel__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! flarum/tags/helpers/tagsLabel */ "flarum/tags/helpers/tagsLabel");
/* harmony import */ var flarum_tags_helpers_tagsLabel__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(flarum_tags_helpers_tagsLabel__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _DiscussionId__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./DiscussionId */ "./src/forum/components/DiscussionId.js");
...
var DiscussionLink = /*#__PURE__*/function (_Link) {
  ...
  _proto.oninit = function oninit(vnode) {
    ...
    this.discussion = flarum_forum_app__WEBPACK_IMPORTED_MODULE_1___default().store.getById('discussions', this.attrs.discussionId);
    if ('flarum-tags' in flarum.extensions && !this.discussion.tags()) {
      flarum_forum_app__WEBPACK_IMPORTED_MODULE_1___default().store.find('discussions', this.attrs.discussionId, {
        include: 'tags'
  ...
  _proto.view = function view() {
    var id = this.attrs.discussionId;
    ...
    }, this.discussion.title(), " ", showId && m(_DiscussionId__WEBPACK_IMPORTED_MODULE_5__["default"], {
      discussionId: id
    }), " ", isComment && m(DiscussionComment, null), " ", 'flarum-tags' in flarum.extensions && this.discussion.tags() && flarum_tags_helpers_tagsLabel__WEBPACK_IMPORTED_MODULE_4___default()(this.discussion.tags().filter(function (tag) {
...
/* harmony import */ var _DiscussionLink__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./DiscussionLink */ "./src/forum/components/DiscussionLink.js");
